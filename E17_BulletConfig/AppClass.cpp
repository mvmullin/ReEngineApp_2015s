...
void AppClass::InitVariables(void)
{
	...
	broadphase = new btDbvtBroadphase(); //used to calculate a list of all colliding bounding boxes.
	...
	//Cube
	fallShape = new btBoxShape(btVector3(0.5, 0.5, 0.5)); //primitive
	btScalar mass = 1;
...
void AppClass::Update(void)
{
	...
	//Reference for floor visual even though physics are done on the plane
